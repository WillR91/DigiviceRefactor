...
namespace Constants {
    ...
    static constexpr int BACKGROUND_HEIGHT = 474;

    // Note: Global scaling is now handled by SDL logical sizing in PCDisplay
    // Individual sprite scaling is no longer needed
