...
DigimonDefinition DigimonDefinition::fromLegacyEnum(DigimonType type) {
    ...
    switch (type) {
        ...
        case DIGI_GABUMON:
            ...
            def.spriteBaseId = "gabumon_sheet";
        ...
        case DIGI_BIYOMON:
            ...
            def.spriteBaseId = "biyomon_sheet";
        ...
        case DIGI_GATOMON:
            ...
            def.spriteBaseId = "gatomon_sheet";
        ...
        case DIGI_GOMAMON:
            ...
            def.spriteBaseId = "gomamon_sheet";
        ...
        case DIGI_TENTOMON:
            ...
            def.spriteBaseId = "tentomon_sheet";
        ...
        case DIGI_PATAMON:
            ...
            def.spriteBaseId = "patamon_sheet";
        ...
        case DIGI_KUWAGAMON:
            ...
            def.spriteBaseId = "kuwagamon_sheet";
        ...
        default:
            ...
            def.digimonClass = DigimonClass::StandardEnemy;
            def.spriteBaseId = "unknown_sheet";
